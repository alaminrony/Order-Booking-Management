                ...
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-info">
                        <div class="inner" style="margin-bottom:15px;">
                            <h3>{{DB::table('order_bookings')->count()}}</h3>
                            <p class="text-center" style="font-size:25px;">Total Order</p>
<!--                            <p style="float:left;">Cash In: <b>{{$data['transactionInCount']['count_value']??''}}</b></p>
                        ...
                        <a href="{{route('orderBooking.index')}}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-success">
                        <div class="inner" style="margin-bottom:15px;">
                            <h3>{{DB::table('buyers')->count()}}</h3>
                            <p class="text-center" style="font-size:25px;">Total Byuer</p>
<!--                            <p style="float:left;">In: <b>{{$data['transactionInCount']['total_tr']??''}}</b></p>
                        ...
                        <a href="{{route('buyer.index')}}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
                <div class="col-lg-3 col-6">
