<div class="modal-content">
    <div class="modal-header clone-modal-header bg-secondary">
        <h4 class="modal-title" id="exampleModalLabel"><i class="fa fa-plus-square"></i> {!!__('lang.CREATE_DEPARTMENT_VS_USERS')!!}</h4>
    </div>
        ...
        <form class="form-horizontal" id="createFormData" method="POST">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    <label for="role_id" class="col-sm-4 col-form-label">@lang('lang.DEPARTMENT') :</label>
                    <div class="col-sm-8">
                        {!!Form::select('department_id',$departments,'',['class'=>'select2 form-control','id'=>'department_id','width'=>'100%'])!!}
