...
<div class="content-wrapper">
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    ...
                    <h1>@lang('lang.BUYER')</h1>
                </div>
                <div class="col-sm-6">
                    <div class="float-right mr-2">
                        <a type="button" class="btn btn-success openCreateModal" data-toggle="modal" title="Create Buyer" data-target="#viewCreateModal"><i class="fa fa-plus-square"></i> Create Buyer</a>
                    </div>
                </div>
            </div>
    ...
    <section class="content">
        <div class="container-fluid">
            {!!Form::open(['route'=>'buyer.filter','method'=>'GET'])!!}
                ...
                <div class="col-md-12">
                    <div class="card card-secondary">
                        <div class="card-header">
                            <h3 class="card-title">@lang('lang.BUYER_LIST')</h3>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div style="float: left;">
                                                {!!Form::open(['route'=>['buyer.destroy',$target->id]])!!}
                                                @method('DELETE')
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.response == "success") {
                            ...
                            toastr.success("@lang('lang.BUYER_CREATED_SUCCESSFULLY')", 'Success', {timeOut: 5000});
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.response == "success") {
                            ...
                            toastr.success("@lang('lang.BUYER_UPDATED_SUCCESSFULLY')", 'Success', {timeOut: 5000});
//                            toastr["success"]("@lang('label.MEET_UP_HAS_BEEN_UPDATED_SUCCESSFULLY')");
                        }
                    }
                });
